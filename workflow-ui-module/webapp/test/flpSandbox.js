		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Taskworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Taskworkflowuimodule-display": {
								"semanticObject": "Taskworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Task.workflowuimodule",
									"url": sap.ui.require.toUrl("Task/workflowuimodule")
								}
							}
						}
					}
